...
#include "mTouchCapLib\mTouchCapADC.h"
...
//#define PIC32MX220_CAP_TOUCH_EVAL_BOARD
  #define PIC32MX220_STARTER_KIT_BOARD
    ...
    #define DIRECTKEY4_CHANNEL  CHANNEL_AN9
    //#define DIRECTKEY5_CHANNEL  CHANNEL_AN10

    // GPIO Initialization values
    #define     INIT_TRISA_VALUE        //0x3c0 //(1<<7) | (1<<9) //Switch 1 on A9, Switch 3 on RA7
    #define     INIT_TRISB_VALUE        0x3c0 //0x000 //1<<4 //Switch 2 on RB4
